  ...
  function filterBooks(filter) {
    switch (filter) {
      case "price_low_to_high":
        return setExplore(explore.slice().sort((a, b) => a.price - b.price));
      case "price_high_to_low":
        return setExplore(explore.slice().sort((a, b) => b.price - a.price));
      case "likes_high_to_low":
        return setExplore(explore.slice().sort((a, b) => b.likes - a.likes));
      default:
        break;
    }
  }
  ...
  return (
    <>
      ...
      <div className="col-md-12 text-center">
        <Link to="">
          {disabled ? <></> : <button id="loadmore" disabled={disabled} className="btn-main lead" onClick={loadMore}>
            Load More
          </button>}
        </Link>
      </div>
