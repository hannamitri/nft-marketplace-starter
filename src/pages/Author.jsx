...
const Author = () => {
  ...
  const [follorwing, setFollowing] = useState(false)
    ...
    <div id="wrapper">
      <div className="no-bottom no-top" id="content">
        ...
        <section
          ...
          style={{ background: `url(${AuthorBanner}) top` , backgroundRepeat: "no-repeat",
                    ...
                    <div className="profile_follow de-flex">
                      <div className="de-flex-col">
                        <div className="profile_follower">
                          <Skeleton width={"104px"} height={"26px"} borderRadius={"8px"}/>
                        </div>
