                    ...
                    <div className="de-flex-col">
                      ...
                      <LoadingPlaceHolder extraStyles={{height:'170px', width:'170px', borderRadius:'50%'}}/>
                        ...
                        <div className="profile_name">
                          <h4>
                            <LoadingPlaceHolder extraStyles={{height:'20px', width:'150px', marginTop: '20px', borderRadius: '10px'}}/>
                    ...
                    <div className="profile_follow de-flex">
                      <div className="de-flex-col">
                        <div className="profile_follower">
                          <LoadingPlaceHolder extraStyles={{height:'40px', width:'120px', marginTop: '20px', borderRadius: '10px'}}/>
                        </div>
                      </div>
                    </div>
                  </div>
